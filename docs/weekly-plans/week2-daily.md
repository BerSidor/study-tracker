...
- [ ] Three working MCP servers built (notes, API-wrapper, database)
- [ ] One polished + documented + pushed to GitHub
- [ ] You can explain tool schemas, `Field`, transports, and auth without notes
- [ ] At least one Discovery Log entry from a hard integration
